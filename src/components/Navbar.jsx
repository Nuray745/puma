...
function Navbar() {
  ...
  return (
    <div className="sticky top-0 z-50 bg-[#181818]">
        <nav className="max-w-[1600px] mx-auto h-16 lg:h-20 px-4 tablet:px-6 lg:px-8 text-white flex items-center justify-between">
            ...
            {/* İkonlar */}
            <div
            className={`font-ff-din-exp flex gap-2 items-center text-white text-xl cursor-pointer 
