      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        ...
        <div>
          <div className="flex flex-col gap-3">
            <div>
              <h1 className="text-[24px] tablet:text-[32px] text-[#191919] font-bold">
                {product.header}
              </h1>
            ...
            <div className="text-base tablet:text-[24px] font-bold">
                  ...
                  {product.colors.map((color, idx) => {
                    ...
                    return (
                      ...
                      >
                        <img
                          src={
                            colorVariation?.preview || "default-color-image.jpg"
                          }
                          alt={color.name}
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  {selectedSize &&
                    (() => {
                      ...
                      const selectedStock =
                        parseInt(selectedRow?.[selectedRow.length - 1], 10) ||
                        0;
            ...
            <div className="py-4 space-y-3">
              <div className="text-base text-[#4D7D04] font-bold flex items-center gap-2">
                ...
                >
                  ...
                  />
                  <path
                    d="M10 10H3v1h7v-1Zm-8 2h7v1H2v-1Z"
                    fill="currentColor"
                  />
                </svg>
